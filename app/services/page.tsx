...
const services = [
  {
    ...
    description:
      "Every surface, seam, and stitch receives our undivided attention. We restore and condition leather, plastic, vinyl, and trim to a supple, like-new finish — rejuvenating worn or faded areas and leaving every panel, from the headliner to the door sills, looking immaculate.",
    features: [
      "Leather restoration, conditioning & pH-balanced protection",
      "Plastic, vinyl & trim surface restoration",
      "Dashboard, console & trim rejuvenation with UV-guard dressing",
      "Complete glass cleaning — streak-free interior windows",
      "Odor neutralization (ozone treatment available)",
      "Air vent purging & headliner cosmetic restoration",
    ],
    time: "4 – 6 hours",
  },
  {
    ...
    description:
      "We treat your paint with the same precision a watchmaker applies to a movement. A multi-stage paint correction and machine polish process removes swirls, oxidation, and micro-marring — enhancing gloss and depth to a level you may not have seen since the car left the factory.",
    features: [
      ...
      "Gloss enhancement & paint surface refinement",
